...
<head>
    ...
    <title>페이지 오류 - BookMarket</title> <%-- 타이틀 변경 --%>
...
<body>
    ...
    <div class="container-fixed py-4">
        <div class="custom-header-box">
            <h1 class="custom-header-title">페이지를 찾을 수 없습니다</h1>
            <p class="custom-header-sub">요청하신 페이지가 존재하지 않습니다 (404 Error)</p>
        </div>

        <div class="row align-items-md-stretch text-center">
            <div class="col-md-12">
                <div class="h-100 p-5 content-box error-message-box"> <%-- content-box 및 error-message-box 클래스 재활용 --%>
                    <h2 class="error-heading">요청하신 페이지를 찾을 수 없습니다.</h2> <%-- 클래스 재활용 --%>
                    <p class="error-detail-text">요청 URL: <%=request.getRequestURL()%></p> <%-- 클래스 재활용 --%>
