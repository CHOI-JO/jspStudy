...
<head>
    ...
    <title>주문 취소 - BookMarket</title> <%-- 타이틀 변경 --%>
...
<body>
    ...
    <div class="container-fixed py-4">
        <div class="custom-header-box">
            <h1 class="custom-header-title">주문 취소</h1>
            <p class="custom-header-sub">주문이 성공적으로 취소되었습니다.</p>
        </div>
    	
        <div class="row align-items-md-stretch text-center">
            <div class="col-md-12">
                <div class="h-100 p-5 content-box cancelled-message-box"> <%-- content-box 및 새로운 클래스 추가 --%>
                    <h2 class="cancelled-heading">주문이 취소되었습니다.</h2>
                    <p class="cancelled-detail-text">주문을 취소해 주셔서 감사합니다. 다른 궁금한 점이 있으시면 언제든지 문의해주세요.</p>
                </div>
            </div>
        </div>
